...
>(
  (
    ...
    <div
      className={cn(
        'flex w-full items-center border-b px-3',
        cmdkInputWrapperClassName
      )}
      cmdk-input-wrapper=""
    >
      ...
      {isSelectedItemsVisible &&
        ...
        (selectedItemsVariant === 'chip' ? (
          <ScrollArea
            className={cn('mr-2 max-w-[200px]', ScrollAreaClassName)}
            type="auto"
          >
            <div
              className={cn(
                ...
                overflowHandle === 'wrap'
                  ? 'flex-wrap'
                  : 'flex-nowrap overflow-auto text-nowrap'
              )}
            >
              {selectedItems.map((item: Item) => (
                <div
                  key={item.id}
                  className="flex flex-nowrap items-center rounded-md bg-gray-100 px-2 py-1"
                >
                  {item.name}
                  <X
          ...
          <ScrollArea
            className={cn('max-w-[200px]', ScrollAreaClassName)}
            type="auto"
          >
            <div
              className={cn(
                'm-1 mr-2 flex items-center',
                overflowHandle === 'wrap'
                  ? 'flex-wrap'
                  : 'flex-nowrap overflow-auto text-nowrap'
              )}
